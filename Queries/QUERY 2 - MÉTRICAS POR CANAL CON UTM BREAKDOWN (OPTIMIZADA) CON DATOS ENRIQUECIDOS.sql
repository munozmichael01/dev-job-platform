    --select top 1 * from TEnterprise 
    --select top 1 * from TCity 
    --select top 1 * from TRegion 
    --select top 1 * from TCountry 
    --select top 1 * from TArea 
    --select top 1 * from TField
